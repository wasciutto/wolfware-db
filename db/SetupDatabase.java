...
public class SetupDatabase {
    ...
    try {
			...
			statement.executeUpdate("INSERT INTO DISCOUNT VALUES ('DIS0001', 'dollar', .99, '2021-01-01', '2021-01-07')");
			statement.executeUpdate("INSERT INTO DISCOUNT VALUES ('DIS0002', 'dollar', .59, '2021-09-01', '2021-01-19')");
			statement.executeUpdate("INSERT INTO DISCOUNT VALUES ('DIS0003', 'dollar', .30, '2021-02-01', '2021-02-07')");
			statement.executeUpdate("INSERT INTO DISCOUNT VALUES ('DIS0004', 'dollar', 1.99, '2021-03-01', '2021-03-07')");
			statement.executeUpdate("INSERT INTO DISCOUNT VALUES ('DIS0005', 'dollar', 2.99, '2021-03-04', '2021-03-07')");
			...
			statement.executeUpdate("INSERT INTO HASDISCOUNT VALUES ('DIS0001', 'PRD0001', 'BTC0000001')");
			statement.executeUpdate("INSERT INTO HASDISCOUNT VALUES ('DIS0002', 'PRD0002', 'BTC0000001')");
			statement.executeUpdate("INSERT INTO HASDISCOUNT VALUES ('DIS0003', 'PRD0003', 'BTC0000001')");
			statement.executeUpdate("INSERT INTO HASDISCOUNT VALUES ('DIS0004', 'PRD0004', 'BTC0000001')");
			statement.executeUpdate("INSERT INTO HASDISCOUNT VALUES ('DIS0005', 'PRD0005', 'BTC0000001')");
			...
			statement.executeUpdate("INSERT INTO SUPPLIEDPRODUCTS VALUES ('TRN000000001', 'STR0001', 'PRD0001', 100, '2020-05-05', '2020-03-01', '2020-07-03', 'BTC0000001','7.00')");
			statement.executeUpdate("INSERT INTO SUPPLIEDPRODUCTS VALUES ('TRN000000002', 'STR0002', 'PRD0002', 25, '2020-05-05', '2020-03-01', '2020-07-03', 'BTC0000002','4.50')");
			statement.executeUpdate("INSERT INTO SUPPLIEDPRODUCTS VALUES ('TRN000000003', 'STR0002', 'PRD0002', 900, '2020-05-05', '2020-03-01', '2020-07-03', 'BTC0000002','4.25')");
			statement.executeUpdate("INSERT INTO SUPPLIEDPRODUCTS VALUES ('TRN000000004', 'STR0003', 'PRD0003', 45, '2020-05-05', '2020-03-01', '2020-07-03', 'BTC0000003','7.50')");
			statement.executeUpdate("INSERT INTO SUPPLIEDPRODUCTS VALUES ('TRN000000005', 'STR0004', 'PRD0003', 40, '2020-05-05', '2020-03-01', '2020-07-03', 'BTC0000004','7.50')");
			statement.executeUpdate("INSERT INTO SUPPLIEDPRODUCTS VALUES ('TRN000000006', 'STR0005', 'PRD0003', 75, '2020-05-05', '2020-03-01', '2020-07-03', 'BTC0000005','7.50')");
			...
			statement.executeUpdate("INSERT INTO MAINTAINS VALUES ('Return', 'STF0001', 'PRD0001','BTC0000001')");
			statement.executeUpdate("INSERT INTO MAINTAINS VALUES ('Transfer', 'STF0001', 'PRD0002','BTC0000001')");
			statement.executeUpdate("INSERT INTO MAINTAINS VALUES ('Transfer', 'STF0001', 'PRD0003','BTC0000001')");
			statement.executeUpdate("INSERT INTO MAINTAINS VALUES ('Transfer', 'STF0001', 'PRD0004','BTC0000001')");
			statement.executeUpdate("INSERT INTO MAINTAINS VALUES ('Return', 'STF0001', 'PRD0005','BTC0000001')");
