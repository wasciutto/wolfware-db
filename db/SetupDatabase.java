...
public class SetupDatabase {
    ...
    try {
			...
			statement.executeUpdate("CREATE TABLE SUPPLIEDPRODUCTS (TRANSACTIONID CHAR(12),STOREID CHAR(7),PRODUCTID CHAR(10),BUYQUANTITY INTEGER,SUPPLIEDDATE DATE,PRODUCTIONDATE DATE,EXPIRATIONDATE DATE,BATCHID CHAR(10),PRIMARY KEY (TRANSACTIONID)");
