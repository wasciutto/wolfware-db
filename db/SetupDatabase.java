...
public class SetupDatabase {
    ...
    try {
			...
			statement.executeUpdate("CREATE TABLE SUPPLIERBILLS (BILLID CHAR(9),BILLAMOUNT DECIMAL(8,2),BILLPAID BOOLEAN ,BATCHID CHAR(10), PRIMARY KEY(BILLID))");
			...
			statement.executeUpdate("CREATE TABLE MANAGESSUPPLIERBILLS (BILLID CHAR(9),SUPPLIERID CHAR(7),STAFFID CHAR(7), PRIMARY KEY(BILLID, SUPPLIERID, STAFFID))");
			...
			statement.executeUpdate("CREATE TABLE MANAGESCUSTOMERREWARDS (BILLID CHAR(9),CUSTOMERID CHAR(7),STAFFID CHAR(7), PRIMARY KEY(BILLID, CUSTOMERID, STAFFID))");
